...
import SocialStudiesStudyApp from './SocialStudiesStudyApp';
...
const ROSE_TOPICS = [
  { id: 'socialstudies1', label: 'Social Studies Unit 1', emoji: '🧭', date: '2026-09-24' },
...
export default function App() {
  ...
  return (
    <GuidanceProvider>
      ...
      {studyTopic === 'socialstudies1' && <SocialStudiesStudyApp />}
