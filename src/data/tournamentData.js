...
export const teams = [
  // --- 3rd Grade Boys ---
  { name: "Camo Cranberries", division: "3rd Boys", seed: 1, roster: [] },
  { name: "Bucket Corgis", division: "3rd Boys", seed: 8, roster: [] },
  { name: "Net Swishers", division: "3rd Boys", seed: 5, roster: [] },
  { name: "Grizzly Bears", division: "3rd Boys", seed: 4, roster: [] },
  { name: "Hersheys", division: "3rd Boys", seed: 3, roster: [] },
  { name: "Burnt Chicken Nuggets", division: "3rd Boys", seed: 6, roster: [] },
  { name: "Tropical Boys", division: "3rd Boys", seed: 7, roster: [] },
  { name: "The Hoops", division: "3rd Boys", seed: 2, roster: [] },

  // --- 3rd Grade Girls ---
  { name: "The Bananas", division: "3rd Girls", seed: 1, roster: [] },
  { name: "Dunkin' Donuts", division: "3rd Girls", seed: 8, roster: [] },
  { name: "Neon Fruits", division: "3rd Girls", seed: 5, roster: [] },
  { name: "Pink Superstars", division: "3rd Girls", seed: 4, roster: [] },
  { name: "Eagles", division: "3rd Girls", seed: 3, roster: [] },
  { name: "Sassy Fashion", division: "3rd Girls", seed: 6, roster: [] },
  { name: "Crazy Coconuts", division: "3rd Girls", seed: 7, roster: [] },
  { name: "Good Vibes", division: "3rd Girls", seed: 2, roster: [] },

  // --- 4th Grade Boys ---
  { name: "CC&G", division: "4th Boys", seed: 1, roster: [] },
  { name: "GOATS", division: "4th Boys", seed: 8, roster: [] },
  { name: "NC Tarheels", division: "4th Boys", seed: 5, roster: [] },
  { name: "Hoopers", division: "4th Boys", seed: 4, roster: [] },
  { name: "The Blue Stars", division: "4th Boys", seed: 3, roster: ["Keaton Griffith", "Vivian Henderson", "Georgia Walters", "Sophia Dakolios"] },
  { name: "Super Stars", division: "4th Boys", seed: 6, roster: [] },
  { name: "Dream Team Champions", division: "4th Boys", seed: 7, roster: [] },
  { name: "Crumble Cookies", division: "4th Boys", seed: 2, roster: [] },

  // --- 4th Grade Girls ---
  { name: "Triple Basket Girls", division: "4th Girls", seed: 1, roster: [] },
  { name: "Peppa Pig Biggies", division: "4th Girls", seed: 8, roster: [] },
  { name: "Pink Palm Trees", division: "4th Girls", seed: 5, roster: [] },
  { name: "The Bucket Boys", division: "4th Girls", seed: 4, roster: ["Henry Pivonka", "Toddy Henderson", "Cars Luck"] },
  { name: "The Howlers", division: "4th Girls", seed: 3, roster: [] },
  { name: "The Kobes", division: "4th Girls", seed: 6, roster: [] },
  { name: "Knee Walkers", division: "4th Girls", seed: 7, roster: ["Emmett Noble", "Aiden Taylor", "Grayson Lewis"] },
  { name: "BUNZ", division: "4th Girls", seed: 2, roster: [] },
  ...
  { name: "The Sea Turtles", division: "5th Boys", seed: 6, roster: [] },
  { name: "Knee Walkers", division: "5th Boys", seed: 7, roster: ["Emmett Noble", "Aiden Taylor", "Grayson Lewis"] },
  { name: "Nothing But Nets", division: "5th Boys", seed: 2, roster: [] },
...
export const brackets = {
  ...
  "4th Boys": {
    quarterFinals: [
      { gameId: "4B-QF1", team1: "CC&G", team2: "GOATS", seed1: 1, seed2: 8 },
      { gameId: "4B-QF2", team1: "Hoopers", team2: "NC Tarheels", seed1: 4, seed2: 5 },
      { gameId: "4B-QF3", team1: "The Blue Stars", team2: "Super Stars", seed1: 3, seed2: 6 },
      { gameId: "4B-QF4", team1: "Crumble Cookies", team2: "Dream Team Champions", seed1: 2, seed2: 7 },
    ],
    semiFinals: [
  ...
  "4th Girls": {
    quarterFinals: [
      { gameId: "4G-QF1", team1: "Triple Basket Girls", team2: "Peppa Pig Biggies", seed1: 1, seed2: 8 },
      { gameId: "4G-QF2", team1: "The Bucket Boys", team2: "Pink Palm Trees", seed1: 4, seed2: 5 },
      { gameId: "4G-QF3", team1: "The Howlers", team2: "The Kobes", seed1: 3, seed2: 6 },
      { gameId: "4G-QF4", team1: "BUNZ", team2: "Knee Walkers", seed1: 2, seed2: 7 },
    ],
    semiFinals: [
