  ...
  mathfacts: {
    ...
    tabs: {
      ...
      mad: {
        ...
        parent: 'Silent for the full minute by design. It exists to rehearse the timed sheet she already sits at school, and a drill she has met at home is a smaller event than one she has not. Adding live feedback would make it a different exercise. Skip is the paper sheet\u2019s "come back to it" — a skipped problem is not recorded as wrong, because she did not answer it, and scoring it against her would teach her to guess rather than move on. Restart asks first and stops the clock while it asks, twice a minute at most — it exists for a genuine mis-tap or an interruption, not for fishing for a better run, and the wording says so. A restarted minute is discarded rather than scored. Its mode and numbers are set separately from Practice, so you can keep the minute matching whatever sheet she actually gets at school while Practice works on something else.',
      },
      progress: {
